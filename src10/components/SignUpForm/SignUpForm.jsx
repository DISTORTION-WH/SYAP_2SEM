                ...
                <div className="field">
                    ...
                    <div className="safetyBar" style={(this.state.finalPassword) ? { display: "block" } : { display: "none" }}>
                        ...
                        <div className='progressBar'>
                              <div className={(this.getPasswordSafety() === 0 ? 'bar-0' :
                                this.getPasswordSafety() === 25 ? 'bar-20' :
                                this.getPasswordSafety() === 50 ? 'bar-40' :
                                this.getPasswordSafety() === 75 ? 'bar-60' :
                                this.getPasswordSafety() === 100 ? 'bar-80' : '')
          }>
        </div>
      </div>
